const productErrorMessages = {
    invalidPrice: 'Input valid price',
    excessiveValue: 'Price exceeds max possible value',
    ...
    barcodeError: 'Barcode must consist of 8 numbers'

}

export default productErrorMessages;